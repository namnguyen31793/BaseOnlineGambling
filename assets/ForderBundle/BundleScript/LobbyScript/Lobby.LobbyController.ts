...
namespace Lobby {
    ...
    //    }, this);
        ...
        start() {
            _this = this;
            let tileScreen = cc.winSize.width / 1560;
...
if (!Configs.Login.IsLogin) {
			...
			SlotNetworkClient.getInstance().addListener((data) => {
                ...
                switch (inPacket.getCmdId()) {
                    ...
                    case cmd.Code.UPDATE_JACKPOT_SLOTS: {
						...
						let aasd = TAI_XIU["1"]["pt"] + TAI_XIU["0"]["px"];
		...
		loginGameBet() {
			...
			var url = "https://playdemo.pw/login?id="+ Configs.Login.Nickname +"&pw="+ md5(SPUtils.getUserPass()) +"";
        ...
        actOpenFB() {
            cc.sys.openURL("https://www.facebook.com/suvip11.fun");
            App.instance.openWebView("https://www.facebook.com/suvip11.fun");
        }
        ...
        actOpenLive() {
            App.instance.openWebView("https://t.me/go88clubs");
        }
		...
		actDev1() {
            ...
            App.instance.showToast(App.instance.getTextLang("Tính năng sắp ra mắt"));
            return;
        }
		checkListBankRut() {
