cc.Class({
    ...
    CreateItem() {
        this.itemParent = cc.find("Container/Normal/Items", this.node);
    ...
    PlayEffectSpin() {
        ...
        this.stateSpin = 0;
        this.stateGetResult = 0;
        this.effectSpin.active = true;
        this.effectSpin.opacity = 255;
    ...
    OnCheckSpinSuccess() {
        ...
        if(this.stateGetResult == 2) {
            this.effectSpin.runAction(cc.fadeOut(0.3));
            this.scheduleOnce(()=>{
                this.animSpin.node.active = true;
                this.animSpin.setAnimation(0, 'man xuong do', false);
                this.scheduleOnce(()=>{
                    this.animSpin.setAnimation(0, 'set-loop', true);
                    this.scheduleOnce(()=>{
                        this.animSpin.setAnimation(0, 'as-loop', false);
                        this.scheduleOnce(()=>{
                            this.animSpin.node.active = false;
                        } , 0.3);
                    } , 1); 
                } , 0.4); 
            } , 0.3); 
