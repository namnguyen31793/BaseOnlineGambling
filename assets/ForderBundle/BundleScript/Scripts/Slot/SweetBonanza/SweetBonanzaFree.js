cc.Class({
    ...
    ShowFree(numberFree, extendMatrix, isNotify, winNormalValue = 0) {
        ...
        if(this.slotView.isFree) {
            ...
            if(extendMatrix > 1 && winNormalValue > 0){
                ...
                this.toDoList.AddWork(()=>{ 
                    this.CreateWinMoneyWithMutl(winNormalValue/extendMatrix, winNormalValue, extendMatrix)},false);
            ...
            if(winNormalValue > 0)
                this.toDoList.AddWork(()=>this.UpdateMoneyResultFree(winNormalValue - winNormalValue/extendMatrix, winNormalValue, this.toDoList, false),true);
        }
        if(numberFree > 0 && !this.slotView.isFree) {
            ...
            this.toDoList.AddWork(()=>{
                ...
                if(numberFree == 5)//fake tru turn dau nhan duoc
                    cc.sys.localStorage.setItem("Key_Free_SnowFall" , numberFree);
    ...
    CreateWinMoneyWithMutl(value, total, multi){
        ...
        eff.getChildByName("total").getComponent(cc.Label).string = "+"+ Global.Helper.formatNumber(total );
