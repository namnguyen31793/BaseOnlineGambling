    ...
    */
    ...
    SetImageItem(id, itemView, loop = false, dragonId = 1) {
        ...
        if(this.slotController.slotUI.CheckIconSpineById(idItem)){
            let anim = this.slotController.slotUI.GetNameSpinById(idItem)
            let animBG = this.slotController.slotUI.GetNameBGById(idItem)
            itemView.getComponent(this.slotController.slotUI.nameClassItem).SetSpineItem(idItem, this.slotController.slotUI.itemSpineData[idItem-1], this.slotController.slotUI.itemSpineBGData[idItem-1], anim, animBG, isGem);  
        }
        else {
            if(this.slotController.isFree)
                itemView.getComponent(this.slotController.slotUI.nameClassItem).SetImageItem(idItem, this.slotController.slotUI.itemImgDataFree[idItem-1], isGem);  
            else
                itemView.getComponent(this.slotController.slotUI.nameClassItem).SetImageItem(idItem, this.slotController.slotUI.itemImgData[idItem-1], isGem);  
        }
    },
    ...
    SetImageItemReal(id, itemView, loop = false, dragonId = 1) {
        ...
        let isGem = (id > 20) ? true : false;
        if(this.slotController.slotUI.CheckIconSpineById(idItem)){
            let anim = this.slotController.slotUI.GetNameSpinById(id)
            let animBG = this.slotController.slotUI.GetNameBGById(idItem)
            itemView.getComponent(this.slotController.slotUI.nameClassItem).SetSpineItem(idItem, this.slotController.slotUI.itemSpineData[idItem-1], this.slotController.slotUI.itemSpineBGData[idItem-1], anim, animBG, isGem);  
        }
        else {
