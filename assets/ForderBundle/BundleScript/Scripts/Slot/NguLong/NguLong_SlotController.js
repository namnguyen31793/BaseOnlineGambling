cc.Class({
        ...
        ctor(){
            ...
            this.NUMBER_LINE = 20;
            this.stackSpin = [];
            this.NAME_BUNDLE_STRING = "39";
            this.inputId = 1;
            this.inputValue = [50, 100, 200, 300, 500];
        },
        ...
        SelectInput(input){
            this.inputId = input;
            if(this.inputId >= this.inputValue.length)
                this.inputId = 0;
            else if(this.inputId < 0)
            this.inputId = this.inputValue.length -1;
            this.slotMenu.UpdateInputType(this.inputValue[this.inputId]);
        },
        /*
        ...
        CheckEndAnimNearWin(freeTurn, bonusTurn) {
            ...
            if(!this.isFree && !this.isBonus) {
                if((freeTurn > 0 || bonusTurn > 0) && this.slotUI.CheckNearWin()) {
                    if(freeTurn > 0){
                        if(this.isFree)
                            this.slotUI_Free.EndItemBonusPreWin();     
                        else
                            this.slotUI.EndItemBonusPreWin();
                    }
                    if(bonusTurn > 0){
                        if(this.isFree)
                            this.slotUI_Free.EndItemFreePreWin();     
                        else
