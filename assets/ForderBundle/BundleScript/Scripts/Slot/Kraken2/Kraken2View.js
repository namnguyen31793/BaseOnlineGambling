...
cc.Class({
    ...
    Init() {
        this.slotType = Global.Enum.GAME_TYPE.SLOT_KRAKEN2;
        this.lineData = 20;
    },
    ...
    SetFreeSpin(numberFree, isNotify = false, lineWin, winNormalValue) {
        this.freeManager.ShowFree(numberFree, isNotify, lineWin, winNormalValue);
    },
