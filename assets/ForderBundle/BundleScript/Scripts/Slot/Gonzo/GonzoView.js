...
cc.Class({
    ...
    Init() {
        this.slotType = Global.Enum.GAME_TYPE.GONZO;
        this.lineData = 50;
    },
    ...
    SetFreeSpin(numberFree, isNotify = false, winNormalValue = 0) {
        this.freeManager.ShowFree(numberFree, isNotify, winNormalValue);
    },
