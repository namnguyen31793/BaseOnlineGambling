cc.Class({
    ...
    ctor() {
        ...
        this.nameClassItem = "NightClub_BonusItem";
        this.listBtn = [];
    ...
    ClickValueBonus(event, index){
        if(this.indexBonus == this.listBonus.length)
            return;
        // this.isCountTime = false;
        this.slotController.slotSound.PlayAudioBonusClick();
        this.time = 20;
    ...
    ShowRewardBonus(){
        ...
        var scaleAction = cc.scaleTo(0.2, 1); //scale to 0.6 in 0.2s
