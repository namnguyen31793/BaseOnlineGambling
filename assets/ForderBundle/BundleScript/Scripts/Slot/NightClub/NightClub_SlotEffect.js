cc.Class({
        ...
        if(this.EffectFree == null){
            ...
            Global.DownloadManager.LoadPrefab(this.slotController.NAME_BUNDLE_STRING,"effectFree", (prefab)=>{
                ...
                spineObj.getComponent(sp.Skeleton).setCompleteListener((trackEntry) => {
                    if (trackEntry.animation.name === 'Free') {
                        seft.WaitEndFree();
                     }
                });
                seft.EffectFree.active = true;
                spineObj.active = true;
                spineObj.getComponent(sp.Skeleton).setAnimation(0,'Free',false);
            });  
        }else{
    ...
    ShowEffectStartBonus(callback){
        ...
        if(this.EffectBonus == null){
            ...
            Global.DownloadManager.LoadPrefab(this.slotController.NAME_BUNDLE_STRING,"effectBonus", (prefab)=>{
                ...
                seft.EffectBonus.getComponent(sp.Skeleton).setAnimation(0,'Bonus',false);
            });  
        }else{
            this.EffectBonus.active = true;
            this.EffectBonus.getComponent(sp.Skeleton).setAnimation(0,'Bonus',false);
        }
    },
    ...
    ShowBonusGame(listBonus, winBonusValue, callback){
        ...
        if(this.BonusGame == null){
            ...
            Global.DownloadManager.LoadPrefab(this.slotController.NAME_BUNDLE_STRING,"PopupBonus", (prefab)=>{
                ...
                seft.BonusGame.getComponent("NightClub_BonusGame").ShowBonusGame(this.slotController, listBonus, winBonusValue, callback, this.slotController.GetBetValue());
            });  
        }else{
            this.BonusGame.active = true;
            this.BonusGame.getComponent("NightClub_BonusGame").ShowBonusGame(this.slotController,listBonus, winBonusValue, callback, this.slotController.GetBetValue());
        }
    },
    /* ---------------- */
        ...
        if(this.EffectBigWin == null){
            ...
            Global.DownloadManager.LoadPrefab(this.slotController.NAME_BUNDLE_STRING,"effectBigWin", (prefab)=>{
                ...
                seft.EffectBigWin.getChildByName("thanglon_eff").getComponent(sp.Skeleton).setCompleteListener((trackEntry) => {
                    if (trackEntry.animation.name === 'Girl1') {
                        seft.WaitBigWin();
                     }
                });
                seft.EffectBigWin.active = true;
                seft.EffectBigWin.getChildByName("thanglon_eff").getComponent(sp.Skeleton).setAnimation(0,'Girl1',false);
            ...
            this.EffectBigWin.getChildByName("thanglon_eff").getComponent(sp.Skeleton).setAnimation(0,'Girl1',false);
        ...
        if(this.EffectJackpot == null){
            ...
            Global.DownloadManager.LoadPrefab(this.slotController.NAME_BUNDLE_STRING,"effectJackpot", (prefab)=>{
                ...
                seft.EffectJackpot.getChildByName("nohu_eff").getComponent(sp.Skeleton).setCompleteListener((trackEntry) => {
                    if (trackEntry.animation.name === 'JackPot-Start') {
                        seft.WaitJackpot();
                     }
                });
                seft.EffectJackpot.active = true;
                seft.EffectJackpot.getChildByName("nohu_eff").getComponent(sp.Skeleton).setAnimation(0,'JackPot-Start',false);
            ...
            this.EffectJackpot.getChildByName("nohu_eff").getComponent(sp.Skeleton).setAnimation(0,'JackPot-Start',false);
    ...
    WaitJackpot(){
        this.EffectJackpot.getChildByName("nohu_eff").getComponent(sp.Skeleton).setAnimation(0,'JackPot-Loop2', true);
