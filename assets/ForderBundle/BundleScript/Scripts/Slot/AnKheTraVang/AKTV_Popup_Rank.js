cc.Class({
    ...
    SetImageItem(id, itemView, loop = false) {
        if(this.slotControler.slotUI.CheckIconSpineById(id)){
            ...
            itemView.getComponent(this.slotControler.slotUI.nameClassItem).SetSpineItem(id, this.itemSpineData[id-1], anim, loop, 1);  
        }
        else
            itemView.getComponent(this.slotControler.slotUI.nameClassItem).SetImageItem(id, this.itemImgData[id-1], 1);  
    },
