...
namespace Configs {
    ...
    export class App {
        ...
        static API: string = "https://iportal.suvip11.fun/api";
		static API2: string = "https://iportal2.suvip11.fun/api";
		static APIROY: string = "https://portal.suvip11.fun/api";
        static API_PAYIN_PAYWELL_BANKS: string = "https://iportal.suvip11.fun/api/payin/paywell/banks";
        static MONEY_TYPE = 1;
        static LINK_DOWNLOAD = "https://suvip11.fun/download";
        static LINK_EVENT = "https://suvip11.fun/event";
        static LINK_SUPPORT = "https://suvip11.fun";
        static USE_WSS = false;
        static LINK_GROUP = "https://t.me/go88clubs";
        ...
        static readonly HOST_SOCKJS = "https://st.suvip11.fun/";
        ...
        static getLinkFanpage() {
            switch (VersionConfig.CPName) {
                default:
                    return "https://www.facebook.com/suvip11.fun";
            }
        }
        ...
        static init() {
            ...
            switch (VersionConfig.ENV) {
                ...
                case VersionConfig.ENV_DEV:
					...
					this.HOST_MINIGAME2.host = "lol." + VersionConfig.DOMAIN_DEV + "";
                ...
                case VersionConfig.ENV_PROD:
					...
					this.HOST_MINIGAME2.host = "lol." + VersionConfig.DOMAIN_PRO + "";
